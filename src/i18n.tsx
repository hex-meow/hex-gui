...
const STRINGS = {
  ...
  meowLifecycle: { en: "Driver lifecycle", zh: "驱动生命周期" },
  ...
  meowMaxTorque: { en: "Max torque (permille)", zh: "最大力矩 (千分比)" },
  meowProfileVelocity: { en: "Profile velocity (rev/s)", zh: "规划速度 (圈/秒)" },
  meowProfileAcceleration: { en: "Acceleration (rev/s²)", zh: "加速度 (圈/秒²)" },
  meowProfileDeceleration: { en: "Deceleration (rev/s²)", zh: "减速度 (圈/秒²)" },
  ...
  meowTpdoGenerations: { en: "TPDO1 / TPDO2 generations", zh: "TPDO1 / TPDO2 代数" },
  meowCanSettings: { en: "CAN settings (object 0x2001)", zh: "CAN 设置（对象 0x2001）" },
  meowNominalBitrate: { en: "Nominal bitrate", zh: "仲裁段波特率" },
  meowDataBitrate: { en: "Data bitrate", zh: "数据段波特率" },
  meowSaveAndPowerCycle: { en: "Save and power-cycle", zh: "保存并重新上电" },
  meowWaitingSettings: { en: "Reading object 0x2001…", zh: "正在读取对象 0x2001…" },
  meowSettingsPreopOnly: {
    en: "CAN settings require an identified, online node in Pre-Operational or Stopped state, before initialization.",
    zh: "CAN 设置要求节点已识别、在线、处于 Pre-Operational 或 Stopped，且尚未初始化。",
  },
  meowSettingsSaved: {
    en: "Settings changed and were saved. Power-cycle the motor to apply them.",
    zh: "设置已修改并保存；请给电机重新上电后生效。",
  },
  meowSettingsResaved: {
    en: "Settings were unchanged and saved again.",
    zh: "设置未变化，已重新执行保存。",
  },
  ...
  consolePickRobot: { en: "Pick a robot or controller hardware from the tree", zh: "从左侧设备树选择机器人或控制器硬件" },
  ...
  hwTitle: { en: "Controller hardware", zh: "控制器硬件" },
  hwAlive: { en: "liveliness online", zh: "liveliness 在线" },
  hwOffline: { en: "liveliness absent", zh: "liveliness 不在" },
  hwSampleAge: { en: "Last sample age", zh: "最新样本年龄" },
  hwPayloadBytes: { en: "Payload bytes", zh: "Payload 字节数" },
  hwPresent: { en: "present", zh: "存在" },
  hwMissing: { en: "missing", zh: "缺失" },
  hwHeaderMissing: {
    en: "The decoded sample has no Header; safety consumers cannot treat it as fresh.",
    zh: "已解码样本缺少 Header；安全消费者不能把它视为新鲜样本。",
  },
  hwWaitingSample: { en: "No sample received in this GUI session yet.", zh: "本次 GUI 会话尚未收到样本。" },
  hwDecodeError: { en: "Payload decode failed", zh: "Payload 解码失败" },
  hwDiscoveryError: { en: "Hardware discovery error", zh: "硬件发现错误" },
  hwSoftwareEstop: {
    en: "Software interlock only — no physical emergency-stop protection.",
    zh: "仅软件联锁 —— 不具备物理急停保护。",
  },
  hwNoInfo: {
    en: "No hw/info provider was found for this controller.",
    zh: "未发现此控制器的 hw/info provider。",
  },
  hwSupervisorVersion: { en: "Supervisor version", zh: "Supervisor 版本" },
  hwInfoReplies: { en: "hw/info replies", zh: "hw/info 应答数" },
  ...
  wifiController: { en: "Controller", zh: "控制器" },
  wifiNoController: { en: "No hex-wifi controller found", zh: "未发现 hex-wifi 控制器" },
  wifiRefresh: { en: "Refresh", zh: "刷新" },
  wifiStatus: { en: "Status", zh: "状态" },
  wifiConnected: { en: "Connected", zh: "已连接" },
  wifiDisabled: { en: "Disabled", zh: "已禁用" },
  wifiConnectedSsid: { en: "Connected SSID", zh: "当前 SSID" },
  wifiRevision: { en: "Revision", zh: "配置版本" },
  wifiScan: { en: "Scan networks", zh: "扫描网络" },
  wifiScanning: { en: "Scanning…", zh: "扫描中…" },
  wifiSelectNetwork: { en: "Use", zh: "选择" },
  wifiSignal: { en: "Signal", zh: "信号" },
  wifiSecurity: { en: "Security", zh: "安全" },
  wifiOpenUnsupported: { en: "Open networks are not supported yet", zh: "暂不支持开放网络" },
  wifiSaved: { en: "Saved networks", zh: "已保存网络" },
  wifiNoSaved: { en: "No saved networks", zh: "没有已保存网络" },
  wifiForget: { en: "Forget", zh: "删除" },
  wifiForgetAll: { en: "Forget all", zh: "全部删除" },
  wifiSsid: { en: "SSID", zh: "SSID" },
  wifiPassword: { en: "Password", zh: "密码" },
  wifiPasswordHint: { en: "8–63 bytes; sent write-only", zh: "8–63 字节；仅写入，不会读回" },
  wifiCountry: { en: "Country", zh: "国家/地区" },
  wifiHidden: { en: "Hidden SSID", zh: "隐藏 SSID" },
  wifiApply: { en: "Validate and apply", zh: "校验并应用" },
  wifiApplying: { en: "Applying…", zh: "应用中…" },
  wifiJob: { en: "Last job", zh: "最近任务" },
  wifiConfigured: { en: "Wi-Fi configuration applied", zh: "Wi-Fi 配置已生效" },
  ...
  liftInaDiagnostics: { en: "Detailed INA diagnostics", zh: "INA 详细诊断" },
  liftInaCurrentError: { en: "Current error", zh: "当前错误" },
  liftInaTransportError: { en: "Current I²C error", zh: "当前 I²C 错误" },
  liftInaLastError: { en: "Last error", zh: "最近错误" },
  liftInaLastTransportError: { en: "Last I²C error", zh: "最近 I²C 错误" },
  liftInaLastAttemptAge: { en: "Last attempt age", zh: "最近尝试距今" },
  liftInaLastSuccessAge: { en: "Last success age", zh: "最近成功距今" },
  liftInaLastErrorAge: { en: "Last error age", zh: "最近错误距今" },
  liftInaConsecutiveGood: { en: "Consecutive successes", zh: "连续成功次数" },
  liftInaConsecutiveErrors: { en: "Consecutive failures", zh: "连续失败次数" },
  liftInaFingerprintMismatch: { en: "Current fingerprint mismatch", zh: "当前指纹不匹配" },
  liftInaLastFingerprintMismatch: { en: "Last fingerprint mismatch", zh: "最近指纹不匹配" },
  liftNever: { en: "Never", zh: "从未" },
